    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.CharField(blank=True, default='Bio is not set.', max_length=100, null=True, verbose_name='Bio')),
                ('avatar', models.ImageField(blank=True, default='default/default_avatar.png', null=True, upload_to='avatars/', verbose_name='Avatar')),
                ('mobile', phonenumber_field.modelfields.PhoneNumberField(blank=True, default='No mobile number.', max_length=128, null=True, region=None, unique=True, verbose_name='Mobile Number')),
